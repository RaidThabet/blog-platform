...
public class ErrorController {
    ...
    public ResponseEntity<ApiErrorResponse> handleIllegalStateException(IllegalStateException exp) {
        ApiErrorResponse error = ApiErrorResponse.builder()
    ...
    public ResponseEntity<ApiErrorResponse> handleEntityNotFoundException(EntityNotFoundException exp) {
        ApiErrorResponse error = ApiErrorResponse.builder()
    ...
    public ResponseEntity<ApiErrorResponse> handleIllegalStateException(BadCredentialsException exp) {
        ApiErrorResponse error = ApiErrorResponse.builder()
    ...
    public ResponseEntity<ApiErrorResponse> handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException exception) {
        ...
        ApiErrorResponse errorResponse = ApiErrorResponse.builder()
                .status(HttpStatus.BAD_REQUEST.value())
                .message(String.format("Invalid value provided for parameter '%s'. Expected type: '%s'.",
